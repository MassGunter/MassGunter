...
- Институт Биофизики СО РАН - номинальная должность инженер, фактический выполняю функции мнс. Провожу эксперименты, обрабатываю данные, пишу статьи.
...
- КрасЦветМет - инженер данных, занимаюсь поддержкой платформы бизнес аналитики (нескольких решений в рамках платформы).
