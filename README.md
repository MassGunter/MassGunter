...
- номинальная должность инженер, фактический выполняю функции мнс. Провожу эксперименты, обрабатываю данные, пишу статьи.
  - принимал участие в двух грантах
...
## Специализации:
#### [Karpov.courses](https://lab.karpov.courses/certificate/be676678-8bd9-4926-bade-fe6b582f0c88/)
## Курсы:
#### Stepik: [Профиль](https://stepik.org/users/58240591/certificates)  
Основные курсы кратко:
- Основы статистики, часть 2, часть 3
